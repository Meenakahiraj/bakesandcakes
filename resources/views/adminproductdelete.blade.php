...
<h1><p style="font-family:Segoe Print;"><b>Delete Product</b></p></h1><hr><br>
<form action="/productdeleteprocess/{{ $cake->id}}" method="post">
   		 {{csrf_field() }}
...
<tr>
    <td></td>
    <td><button class="btn btn-info" type="submit">Delete</button></td>
</tr>
