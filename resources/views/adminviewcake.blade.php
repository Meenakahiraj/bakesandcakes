...
<nav class="navbar navbar-expand-lg navbar-dark bg-info ">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" method="post" action="/prosearch">
      {{csrf_field() }}
...
<h1><p style="font-family:Segoe Print;"><b>View Cakes</b></p></h1><hr><br>
    ...
    @foreach($cake as $cakes)
        ...
        <tr>
            ...
            <td>{{ $cakes->pcost }}</td>
            <td>{{ $cakes->pdesc }}</td>
            <td><a class="btn btn-warning" href="/cakeedit/{{$cakes->id}}/edit">Edit</a></td>
            <td><a class="btn btn-danger" href="/product/{{$cakes->id}}/delete">Delete</a></td>
        </tr>
        @endforeach
    </table>
