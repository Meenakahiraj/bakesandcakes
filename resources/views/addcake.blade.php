...
<p style="font-family:Bauhaus 93;color:dark blue"><b>Welcome {{session('loggeduser')}}</b></p></h1>
</marquee>
</center>
...
<tr>
    <td>Product Name</td>
    <td><input type="text" class="formcontrol" name="pname"></td>
</tr>
<tr>
    <td>Cost</td>
    <td><input type="text" class="formcontrol" name="pcost"></td>
</tr>
<tr>
    <td>Description</td>
    <td><input type="text" class="formcontrol" name="pdesc"></td>
</tr>
<tr>
    <td>Img</td>
